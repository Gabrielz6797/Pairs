...
public class PictureManager : MonoBehaviour
{
    ...
    public Vector2 startPosition = new Vector2(-1.65f, 2f);
    ...
    private Vector2 _offest = new Vector2(1.1f, 1.4f);
    ...
    private void loadMaterials()
    {
        ...
        _firstMaterial =
            Resources.Load(materialFilePath + firstMaterialName, typeof(Material)) as Material;
    }
